                            ...
                            {rep?(
                              ...
                              <div className="pill" style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,flex:1,minWidth:0,background:"#e8f5e9",borderRadius:20,padding:"9px 14px",fontSize:14,color:"#2e7d32",border:"1px solid #c8e6c9"}}>
                                <div style={{display:"flex",alignItems:"center",gap:8,minWidth:0}}>
                                  ...
                                  <span style={{fontSize:10,color:"#1a1a2e",background:"#a5d6a7",borderRadius:20,padding:"2px 8px",flexShrink:0}}>Sub for {name.length>8?name.slice(0,8)+'…':name}</span>
                                </div>
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:50,padding:16}}
          ...
          {modal.type==="add"&&(
            <div style={{background:"#fff",borderRadius:20,padding:"28px 24px",width:"100%",maxWidth:360,animation:"popIn 0.2s ease",boxShadow:"0 24px 80px rgba(0,0,0,0.2)"}}>
              ...
              <p style={{fontSize:11,color:"#a09880",textAlign:"center",margin:"0 0 12px",lineHeight:1.5}}>Your name and PIN are stored solely to manage your class bookings at Celbridge Padel Academy. This information is not shared with anyone.</p>
